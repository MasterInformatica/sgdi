...
\begin{frame}[shrink]
  ...
  \includegraphics[width=\textwidth]{images/randomForest/bagging.png}


  % \begin{tabular}{ccccc}
  %   Sexo & Altura & Peso & Exp. & Act. \\ \hline
  %   \rowcolor[gray]{.9} H & 1,55 & 45 & A+ & Fútbol \\
  %   \rowcolor[gray]{.9}H & 1,67 & 58 & C & Fútbol \\
  %   M & 1,45 & 45 & B & Fútbol \\
  %   \rowcolor[gray]{.9}M & 1,58 & 50 & A+ & Pádel \\
  %   H & 1,20 & 40 & B & Fútbol \\
  %   $\cdots$ & $\cdots$ & $\cdots$ & $\cdots$ & $\cdots$ \\ \hline
  % \end{tabular}
