...
\begin{frame}
  ...
  optimización de partes de código, incluye:
  \begin{itemize}
  ...
  \begin{tikzpicture}
    ...
    \only<2->{\node[] (def) at (0.5,2) {
        ...
        \begin{minipage}{0.9\textwidth}
          ...
          La fórmula queda para el atributo $i$, siendo D el
...
\begin{frame}[fragile]
  \frametitle{Ejemplo --  Árbol y Construcción de Reglas}
\begin{tikzpicture}
\tikzpicdimlarge
\only<1->{\node[] () at (0,9)
  {\includegraphics[width=0.65\textwidth]{images/C45tree.png}};}
\only<2->{\node[] () at (0,5)
  {\includegraphics[width=0.65\textwidth]{images/C45rule.png}};}
